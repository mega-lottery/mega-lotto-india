...
class LotteryApp {
    constructor() {
        ...
        this.razorpayKeyId = "rzp_test_51MockGatewayKey";
    ...
    getExactDrawTarget(pool) {
        ...
        if (pool.id === 0) { // ₹19 Pocket Booster: Every 15 Mins / On Full
        ...
        } else if (pool.id === 1) { // ₹49 Daily Super: Daily 9:00 PM IST
        ...
        } else if (pool.id === 2) { // ₹99 Silver Bumper: Daily 10:00 PM IST
        ...
        } else if (pool.id === 3) { // ₹199 Gold Rush: Mon / Wed / Fri 8:00 PM IST
        ...
        } else if (pool.id === 4) { // ₹499 Diamond Express: Sunday 8:00 PM IST
        ...
        } else if (pool.id === 5) { // ₹999 Saturday Mega: Saturday 8:00 PM IST
